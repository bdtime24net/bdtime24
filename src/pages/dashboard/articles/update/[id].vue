...
const fetchArticle = async () => {
  try {
    const response = await axios.get(`/api/article/id/${articleId.value}`);
    const data = response.data;

    if (data.success) {
      title.value = data.article.title;
      slug.value = data.article.slug;
      description.value = data.article.description;
      imageUrls.value = data.article.urlToImage;
      categoryId.value = data.article.categoryId;
      tagId.value = data.article.tagId;
    } else {
